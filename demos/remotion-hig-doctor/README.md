...
A [Remotion](https://www.remotion.dev/) video that visualizes `hig-doctor audit` results — 382 pattern rules across 12 frameworks, animated category charts, detection breakdowns, and a framework coverage grid.
